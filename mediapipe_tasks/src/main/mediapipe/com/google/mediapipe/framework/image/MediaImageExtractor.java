...
/**
 * Utility for extracting {@link Image} from {@link MPImage}.
 *
...
public class MediaImageExtractor {
  ...
  /**
   * Extracts a {@link Image} from a {@link MPImage}. Currently it only works for
   * {@link MPImage} that built from {@link MediaImageBuilder}.
   *
   * @param image the image to extract {@link Image} from.
   * @return {@link Image} that stored in {@link MPImage}.
