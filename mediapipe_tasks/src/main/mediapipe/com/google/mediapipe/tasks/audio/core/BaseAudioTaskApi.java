...
public class BaseAudioTaskApi implements AutoCloseable {
  ...
  /**
   * Creates an {@link AudioRecord} instance to record audio stream. The returned
   * AudioRecord instance is initialized and client needs to call {@link
   * AudioRecord#startRecording} method to start recording.
   *
   ...
   * @return an {@link AudioRecord} instance in {@link
  ...
  /**
   * Creates an {@link AudioRecord} instance to record audio stream that has mono
